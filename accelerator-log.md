...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=vrabbi&repo=demo-poc-01",
  "owner" : "platform-team",
  "system" : "demo-apps"
}
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->demo-poc-01]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=vrabbi&repo=demo-poc-01'
